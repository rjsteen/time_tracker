...
defmodule TimeTrackerWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: TimeTrackerWeb.Coherence.EmailView, layout: {TimeTrackerWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
